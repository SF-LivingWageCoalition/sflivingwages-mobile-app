...
## VIews
#### Campaign 
The orgainzation's main campaigns and goals are listed here and provides link to the partition websites as well as extra information. 
...
#### Auction/Shop
The organization occasionally host a auction event where user who has this app can particate in biding item to support the organization movement. There are Books, CDs, DVDs listed as well with external links to the website.

#### Tweet 
The app display tweets from the organzation tweeter account.
...
#### Assist 
User can enter their siutation and sent it to the organization for help
