...
export default function PressCoverage() {
    ...
    const getData = async () => {
        const response = await (await fetch('https://www.livingwage-sf.org/wp-json/wp/v2/posts?per_page=3&category=closing_the_wage_gap')).json();
    ...
    return (
        <ScrollView style={{ flex: 1, flexDirection: 'column' }}>
            <Text style={styles.textStyle}>Closing The Wage Gap</Text>
